...
# 416
ll_sales <- read.csv("C:/Users/caiwenli/Box Sync/Marketing Intelligence/Data Science/Clients/Lumber Liquidators/Sales Export 2019/Flash Sales by Order Date.csv")
ll_store_list <- read.csv("C:/Users/caiwenli/Box Sync/Marketing Intelligence/Data Science/Clients/Lumber Liquidators/Sales Export 2019/store list.csv")
```
...
```{r weather data}
w_data_18 <- read.csv("C:/Users/caiwenli/Box Sync/Marketing Intelligence/Data Science/R/R Server/R-DCM/Data Share (Only Data in the folder)/weather/gcp_gsod_2018.csv")
w_data_19 <- read.csv("C:/Users/caiwenli/Box Sync/Marketing Intelligence/Data Science/R/R Server/R-DCM/Data Share (Only Data in the folder)/weather/gcp_gsod_2019.csv")
w_station <- read.csv("C:/Users/caiwenli/Box Sync/Marketing Intelligence/Data Science/R/R Server/R-DCM/Data Share (Only Data in the folder)/weather/gcp_gsod_station.csv")
tbl_vars(w_data_18)
tbl_vars(w_station)
```
...
```{r data exporting}
write.csv(region_weather,"C:/Users/caiwenli/Box Sync/Marketing Intelligence/Data Science/R/R Server/R-DCM/clients/Lumber Liquidators/Assets/Outputs/sale_weather_region_store.csv")
write.csv(sale_weather_trend,"C:/Users/caiwenli/Box Sync/Marketing Intelligence/Data Science/R/R Server/R-DCM/clients/Lumber Liquidators/Assets/Outputs/sale_weather_trend.csv")
write.csv(plot_corr,"C:/Users/caiwenli/Box Sync/Marketing Intelligence/Data Science/R/R Server/R-DCM/clients/Lumber Liquidators/Assets/Outputs/sale_weather_corr.csv")
```
